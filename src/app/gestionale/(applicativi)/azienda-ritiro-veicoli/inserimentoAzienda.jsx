  ...
  return (
    ...
    <div className={`${onDisplay === 'on' ? '' : 'hidden'} w-full h-full`}>
      <form onSubmit={handleSubmit} className="grid grid-cols-12 gap-4">
        ...
        <div className='grid grid-cols-12 gap-4 p-6 col-span-12 rounded-2xl dark:shadow-lg min-w-0 h-full bg-neutral-100 dark:bg-neutral-950/40'>
        ...
        <div className='grid grid-cols-12 gap-4 p-6 col-span-12 rounded-2xl dark:shadow-lg min-w-0 h-full border border-neutral-200 dark:border-neutral-800'>
