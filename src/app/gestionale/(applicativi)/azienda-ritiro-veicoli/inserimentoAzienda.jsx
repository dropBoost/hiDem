  ...
  return (
    ...
    <div className={`${onDisplay === 'on' ? '' : 'hidden'} w-full h-full`}>
      <form onSubmit={handleSubmit} className="grid grid-cols-12 gap-4">
        ...
        <div className='grid grid-cols-12 gap-4 p-6 col-span-12 rounded-2xl shadow-lg min-w-0 h-full bg-white dark:bg-neutral-950/40'>
        ...
        <div className='grid grid-cols-12 gap-4 p-6 col-span-12 rounded-2xl shadow-lg min-w-0 h-full bg-white dark:bg-neutral-900 border'>
