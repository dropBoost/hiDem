                ...
                <div className="flex flex-row justify-between w-full h-full">
                    <div className="flex flex-col justify-start items-start lg:min-w-[16rem] h-full gap-1">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className={`border border-brand rounded-lg px-2 text-sm font-semibold uppercase truncate text-ellipsis ${tipologiaD == "privato" ? "text-yellow-600" : "text-blue-600"}`}>{targa} <font className="text-xs text-neutral-500 font-medium italic uppercase">{telaio}</font></span>
                        ...
                        <>
                            ...
                            <span className="text-xs font-light truncate">{nome} {cognome}</span>
