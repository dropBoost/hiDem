...
export default function SECTIONddtPending({onDisplay, setStatusAziende}) {
  ...
  async function handleSubmit(e) {
    ...
    return (
        ...
        <div className="flex flex-col gap-4">    
            ...
            <form id="inserimentoCamiosssn" onSubmit={handleSubmit} className="flex flex-col gap-4 bg-neutral-950 p-5 rounded-2xl">
